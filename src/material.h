...
class metal : public material {
    public:
        ...
        bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const override {
            ...
            reflected = unit_vector(reflected) + (fuzz * random_unit_vector()); // How fuzzy the reflection is
...
// Dielectric material can be used for things like glass as it refracts rays
class dielectric : public material {
    public:
        ...
        bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const override {
            ...
            //Must ensure that the ray can actually refract based on total internal reflection
